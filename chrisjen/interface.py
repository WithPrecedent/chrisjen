...
class Project(object):
    ...
    filer: Optional[amos.Filer] = None
    bases: MutableMapping[str, Type[Any]] = base.PROJECT_BASES
...
class Project(object):
    ...
    name: Optional[str] = None
    settings: Optional[bobbie.Settings] = None
    filer: Optional[filing.Filer] = None
...
# def set_structure(item: Structure) -> None:
